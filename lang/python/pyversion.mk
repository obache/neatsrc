...
.elif defined(PYTHON_VERSION_REQD)
PYVERSSUFFIX=				${PYTHON_VERSION_REQD:C/^([0-9])/\1./1}
PYPKGPREFIX=				py${PYTHON_VERSION_REQD}
.endif
...
_USER_VARS.pyversion=	PYTHON_VERSION_DEFAULT PYTHON_VERSIONS_PREFERRED
_PKG_VARS.pyversion=	\
