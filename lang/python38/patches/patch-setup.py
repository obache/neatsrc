...
@@ -652,6 +652,8 @@ class PyBuildExt(build_ext):
...
@@ -686,6 +688,9 @@ class PyBuildExt(build_ext):
...
@@ -897,8 +902,6 @@ class PyBuildExt(build_ext):
...
@@ -1000,8 +1003,7 @@ class PyBuildExt(build_ext):
...
@@ -1248,6 +1250,31 @@ class PyBuildExt(build_ext):
         dbm_order = ['gdbm']
...
@@ -1259,7 +1286,7 @@ class PyBuildExt(build_ext):
             dbmext = None
...
@@ -1659,6 +1686,8 @@ class PyBuildExt(build_ext):
...
+            uuid_incs = find_file("uuid/uuid.h", self.inc_dirs, [])
         if uuid_incs is not None:
             if self.compiler.find_library_file(self.lib_dirs, 'uuid'):
                 uuid_libs = ['uuid']
@@ -2055,10 +2084,7 @@ class PyBuildExt(build_ext):
...
+            include_dirs = ['Modules/_decimal/libmpdec']
             ...
             sources = [
               '_decimal/_decimal.c',
@@ -2206,6 +2232,7 @@ class PyBuildExt(build_ext):
